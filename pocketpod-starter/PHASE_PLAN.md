...
Stop condition:
✅ Admins can create, edit, delete, search, and page Product/Post records through the Flutter admin UI. Relation dropdowns use protected server-provided options, and admin authorization is explicitly guarded by Serverpod Auth with `Scope.admin`.
