...
--
-- Class BenchmarkRecord as table benchmark_record
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('pocketpod', '20260630085239040-auth-bootstrap', (unixepoch('now', 'subsecond') * 1000))
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260630085239040-auth-bootstrap', "timestamp" = (unixepoch('now', 'subsecond') * 1000);
